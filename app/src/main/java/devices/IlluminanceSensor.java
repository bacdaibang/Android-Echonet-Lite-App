...
/**
 * Created by VietBac on 12/6/2016.
 */
public class IlluminanceSensor extends Device {
    boolean operationStatus;
    float value;
    String timestamp;
    String location;

    public IlluminanceSensor(String nameDevice, int id, String type, int groupCode, int classCode, int instanceCode, String nodeIp) {
